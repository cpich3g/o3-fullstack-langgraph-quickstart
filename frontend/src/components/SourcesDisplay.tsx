...
import { ExternalLink, CheckCircle, XCircle, ChevronDown, ChevronRight } from 'lucide-react';
  ...
  return (
    <div className="bg-card rounded-lg border border-border overflow-hidden">
      <button
        ...
        className="w-full px-4 py-3 bg-muted border-b border-border hover:bg-muted/80 transition-colors duration-200 text-left"
      >
      ...
      {isExpanded && (
        <div className="p-4 animate-fadeInUpSmooth">
